...
def get_theaters():
    ...
    param  = {'apikey':'0b2bdeda43b5688921839c8ecb20399b', 'city':'%E5%8C%97%E4%BA%AC','start':'0','count':'15','client':'','udid':''}
...
def get_movie(id):
    ...
    param = {'apikey':'0b2bdeda43b5688921839c8ecb20399b', 'city':'%E5%8C%97%E4%BA%AC','client':'','udid':''}
